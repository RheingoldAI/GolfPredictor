...
function getSeedData(tournament) {
  ...
  // Odds updated from Hard Rock Bet / FanDuel / BetMGM as of 3/9/2026.
  // For other tournaments, CourseFit recalculates from COURSE_PROFILES weights.

  var raw = [
    // === TIER 1: Favorites (top 10 by odds) ===
    ['Scottie Scheffler',   0.92, 271, 5.5, 0.200, 2.80, 3.0,  {approach:10, aroundGreen:9, teeToGreen:10, offTee:9, putting:6, courseHist:10}],
    ['Rory McIlroy',        0.85, 274, 6.0, 0.077, 2.10, 6.0,  {approach:8, aroundGreen:7, teeToGreen:9, offTee:9, putting:7, courseHist:9}],
    ['Collin Morikawa',     0.88, 273, 5.5, 0.059, 2.20, 3.0,  {approach:10, aroundGreen:7, teeToGreen:9, offTee:7, putting:6, courseHist:7}],
    ['Xander Schauffele',   0.87, 274, 5.8, 0.048, 2.00, 4.5,  {approach:9, aroundGreen:8, teeToGreen:9, offTee:8, putting:7, courseHist:7}],
    ['Tommy Fleetwood',     0.83, 275, 5.8, 0.038, 1.80, 4.0,  {approach:9, aroundGreen:8, teeToGreen:8, offTee:7, putting:7, courseHist:8}],
    ['Ludvig Aberg',        0.85, 274, 6.2, 0.038, 1.90, 3.5,  {approach:9, aroundGreen:7, teeToGreen:9, offTee:8, putting:6, courseHist:6}],
    ['Si Woo Kim',          0.86, 275, 6.0, 0.032, 1.60, 3.0,  {approach:8, aroundGreen:8, teeToGreen:8, offTee:6, putting:7, courseHist:10}],
    ['Hideki Matsuyama',    0.84, 275, 6.0, 0.032, 1.90, 4.0,  {approach:9, aroundGreen:8, teeToGreen:9, offTee:7, putting:5, courseHist:8}],
    ['Cameron Young',       0.75, 277, 7.0, 0.032, 1.40, 6.0,  {approach:7, aroundGreen:6, teeToGreen:8, offTee:8, putting:5, courseHist:5}],
    ['Min Woo Lee',         0.80, 277, 6.5, 0.032, 1.30, 4.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:7, putting:7, courseHist:7}],

    // === TIER 2: Strong contenders (ADP 11-25) ===
    ['Russell Henley',      0.81, 278, 6.0, 0.032, 1.20, 5.0,  {approach:8, aroundGreen:7, teeToGreen:7, offTee:6, putting:7, courseHist:7}],
    ['Akshay Bhatia',       0.82, 275, 6.5, 0.024, 1.70, 2.5,  {approach:8, aroundGreen:7, teeToGreen:8, offTee:7, putting:7, courseHist:7}],
    ['Patrick Cantlay',     0.83, 277, 5.8, 0.024, 1.30, 7.0,  {approach:8, aroundGreen:7, teeToGreen:8, offTee:6, putting:7, courseHist:6}],
    ['Sahith Theegala',     0.82, 276, 6.2, 0.020, 1.50, 3.5,  {approach:8, aroundGreen:7, teeToGreen:8, offTee:7, putting:6, courseHist:7}],
    ['Viktor Hovland',      0.82, 277, 6.0, 0.018, 1.40, 8.0,  {approach:8, aroundGreen:4, teeToGreen:8, offTee:8, putting:5, courseHist:6}],
    ['Sungjae Im',          0.82, 278, 5.8, 0.015, 1.10, 6.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:6, putting:7, courseHist:7}],
    ['Justin Thomas',       0.78, 278, 6.5, 0.015, 1.20, 10.0, {approach:8, aroundGreen:7, teeToGreen:8, offTee:7, putting:7, courseHist:7}],
    ['Daniel Berger',       0.72, 280, 6.8, 0.016, 1.00, 8.0,  {approach:8, aroundGreen:7, teeToGreen:8, offTee:7, putting:6, courseHist:6}],
    ['Wyndham Clark',       0.78, 278, 6.5, 0.012, 1.20, 7.0,  {approach:7, aroundGreen:6, teeToGreen:8, offTee:8, putting:6, courseHist:5}],
    ['Shane Lowry',         0.80, 278, 6.0, 0.012, 1.10, 8.0,  {approach:7, aroundGreen:8, teeToGreen:7, offTee:6, putting:7, courseHist:6}],
    ['Tony Finau',          0.79, 278, 6.2, 0.010, 1.10, 8.0,  {approach:7, aroundGreen:6, teeToGreen:8, offTee:8, putting:5, courseHist:5}],
    ['Sam Burns',           0.79, 278, 6.5, 0.010, 1.10, 7.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:7, putting:7, courseHist:6}],
    ['Jake Knapp',          0.76, 278, 7.0, 0.010, 1.20, 5.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:9, putting:5, courseHist:6}],
    ['Robert MacIntyre',    0.78, 278, 6.5, 0.010, 1.10, 5.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:7, putting:6, courseHist:6}],
    ['Sepp Straka',         0.79, 279, 6.2, 0.010, 1.00, 6.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:7, putting:6, courseHist:5}],

    // === TIER 3: Solid mid-round picks (ADP 26-50) ===
    ['Justin Rose',         0.77, 279, 6.5, 0.008, 0.90, 8.0,  {approach:8, aroundGreen:7, teeToGreen:7, offTee:6, putting:6, courseHist:7}],
    ['Tom Hoge',            0.80, 279, 6.0, 0.008, 0.90, 6.0,  {approach:8, aroundGreen:7, teeToGreen:7, offTee:6, putting:6, courseHist:6}],
    ['Corey Conners',       0.80, 280, 5.8, 0.008, 0.90, 7.0,  {approach:9, aroundGreen:6, teeToGreen:7, offTee:6, putting:4, courseHist:6}],
    ['Denny McCarthy',      0.78, 281, 6.0, 0.006, 0.70, 7.0,  {approach:6, aroundGreen:7, teeToGreen:6, offTee:5, putting:9, courseHist:5}],
    ['Keegan Bradley',      0.76, 281, 6.5, 0.007, 0.80, 8.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:7, putting:6, courseHist:6}],
    ['Brian Harman',        0.78, 281, 5.8, 0.006, 0.75, 8.0,  {approach:7, aroundGreen:8, teeToGreen:7, offTee:5, putting:7, courseHist:6}],
    ['Matt Fitzpatrick',    0.77, 281, 6.2, 0.007, 0.80, 9.0,  {approach:8, aroundGreen:7, teeToGreen:7, offTee:5, putting:6, courseHist:6}],
    ['Chris Kirk',          0.76, 281, 6.5, 0.006, 0.70, 8.0,  {approach:7, aroundGreen:7, teeToGreen:7, offTee:6, putting:6, courseHist:5}],
    ['Davis Riley',         0.74, 282, 6.5, 0.005, 0.70, 7.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:7, putting:5, courseHist:4}],
    ['Taylor Moore',        0.73, 282, 6.8, 0.005, 0.65, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:7, putting:6, courseHist:4}],
    ['Eric Cole',           0.75, 281, 6.5, 0.006, 0.75, 7.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:7, putting:5, courseHist:4}],
    ['Maverick McNealy',    0.74, 282, 6.5, 0.005, 0.60, 8.0,  {approach:6, aroundGreen:7, teeToGreen:6, offTee:6, putting:7, courseHist:5}],
    ['J.T. Poston',         0.76, 281, 6.0, 0.005, 0.65, 8.0,  {approach:7, aroundGreen:6, teeToGreen:6, offTee:6, putting:7, courseHist:5}],
    ['Adam Scott',          0.74, 282, 6.5, 0.005, 0.60, 10.0, {approach:7, aroundGreen:6, teeToGreen:7, offTee:7, putting:5, courseHist:7}],
    ['Christiaan Bezuidenhout', 0.76, 282, 6.0, 0.005, 0.65, 7.0, {approach:7, aroundGreen:7, teeToGreen:7, offTee:5, putting:6, courseHist:4}],
    ['Jason Day',           0.72, 283, 6.8, 0.005, 0.55, 12.0, {approach:6, aroundGreen:7, teeToGreen:6, offTee:6, putting:7, courseHist:7}],
    ['Harris English',      0.74, 282, 6.5, 0.004, 0.55, 9.0,  {approach:6, aroundGreen:7, teeToGreen:6, offTee:6, putting:6, courseHist:5}],
    ['Aaron Rai',           0.75, 282, 6.0, 0.005, 0.65, 7.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:5, putting:6, courseHist:4}],
    ['Matthieu Pavon',      0.72, 283, 6.5, 0.004, 0.55, 7.0,  {approach:7, aroundGreen:6, teeToGreen:7, offTee:6, putting:5, courseHist:3}],
    ['Seamus Power',        0.72, 283, 6.5, 0.004, 0.55, 8.0,  {approach:7, aroundGreen:6, teeToGreen:6, offTee:6, putting:6, courseHist:4}],
    ['Max Greyserman',      0.70, 283, 6.8, 0.004, 0.55, 7.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:7, putting:5, courseHist:3}],

    // === TIER 4: Late-round targets (ADP 51-80) ===
    ['Keith Mitchell',      0.68, 284, 7.0, 0.004, 0.50, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:8, putting:5, courseHist:4}],
    ['Rickie Fowler',       0.65, 285, 7.5, 0.004, 0.45, 15.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:6, courseHist:6}],
    ['Jordan Spieth',       0.62, 285, 7.5, 0.003, 0.40, 18.0, {approach:5, aroundGreen:7, teeToGreen:5, offTee:4, putting:8, courseHist:7}],
    ['Cam Davis',           0.70, 284, 6.8, 0.003, 0.50, 10.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:7, putting:5, courseHist:4}],
    ['Taylor Pendrith',     0.68, 284, 7.0, 0.003, 0.50, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:8, putting:4, courseHist:3}],
    ['Max Homa',            0.68, 284, 7.0, 0.004, 0.50, 12.0, {approach:7, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:5}],
    ['Davis Thompson',      0.70, 283, 6.8, 0.004, 0.55, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:7, putting:5, courseHist:3}],
    ['Alex Noren',          0.72, 283, 6.5, 0.003, 0.50, 10.0, {approach:7, aroundGreen:7, teeToGreen:6, offTee:5, putting:5, courseHist:5}],
    ['Mackenzie Hughes',    0.70, 284, 6.8, 0.003, 0.45, 9.0,  {approach:7, aroundGreen:6, teeToGreen:6, offTee:5, putting:6, courseHist:5}],
    ['Ben Griffin',         0.68, 284, 7.0, 0.003, 0.45, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Kurt Kitayama',       0.67, 284, 7.0, 0.004, 0.50, 10.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:7, putting:5, courseHist:5}],
    ['Lucas Glover',        0.72, 283, 6.5, 0.003, 0.45, 12.0, {approach:7, aroundGreen:6, teeToGreen:6, offTee:5, putting:6, courseHist:6}],
    ['Stephan Jaeger',      0.70, 284, 6.8, 0.003, 0.45, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:6, courseHist:3}],
    ...
    ['Nick Taylor',         0.68, 284, 7.0, 0.003, 0.45, 10.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:5, putting:6, courseHist:4}],
    ['Lee Hodges',          0.68, 284, 7.0, 0.003, 0.45, 9.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Mark Hubbard',        0.65, 285, 7.2, 0.002, 0.35, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:6, courseHist:3}],
    ['Brooks Koepka',       0.62, 285, 7.5, 0.008, 0.50, 15.0, {approach:7, aroundGreen:5, teeToGreen:7, offTee:7, putting:4, courseHist:5}],
    ['Alex Smalley',        0.68, 284, 7.0, 0.003, 0.45, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:5, putting:6, courseHist:3}],
    ['Erik van Rooyen',     0.65, 285, 7.2, 0.003, 0.40, 10.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Harry Hall',          0.65, 285, 7.0, 0.003, 0.42, 8.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Thorbjorn Olesen',    0.63, 286, 7.2, 0.002, 0.38, 10.0, {approach:6, aroundGreen:6, teeToGreen:6, offTee:5, putting:5, courseHist:4}],
    ['Patton Kizzire',      0.64, 285, 7.0, 0.002, 0.40, 10.0, {approach:6, aroundGreen:6, teeToGreen:5, offTee:5, putting:6, courseHist:4}],
    ['Andrew Putnam',       0.65, 285, 7.0, 0.002, 0.40, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:5, putting:6, courseHist:3}],
    ['Matt McCarty',        0.64, 285, 7.2, 0.003, 0.42, 8.0,  {approach:6, aroundGreen:5, teeToGreen:6, offTee:6, putting:5, courseHist:2}],
    ['Patrick Rodgers',     0.62, 286, 7.2, 0.002, 0.35, 10.0, {approach:6, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:3}],
    ['Ryan Fox',            0.63, 286, 7.5, 0.003, 0.40, 12.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:7, putting:4, courseHist:3}],
    ['Gary Woodland',       0.58, 287, 7.5, 0.002, 0.30, 15.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:7, putting:5, courseHist:5}],

    // === TIER 5: Deep field (ADP 81-123) ===
    ['Ryo Hisatsune',       0.63, 286, 7.2, 0.002, 0.38, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:6, putting:5, courseHist:2}],
    ['Kevin Yu',            0.62, 286, 7.2, 0.002, 0.35, 9.0,  {approach:6, aroundGreen:5, teeToGreen:6, offTee:6, putting:5, courseHist:2}],
    ['Mac Meissner',        0.62, 286, 7.5, 0.002, 0.35, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:2}],
    ['J.J. Spaun',          0.62, 286, 7.2, 0.002, 0.35, 12.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:4}],
    ['Adam Schenk',         0.63, 286, 7.0, 0.002, 0.35, 10.0, {approach:6, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:3}],
    ['Chad Ramey',          0.58, 287, 7.5, 0.001, 0.28, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:3}],
    ['Jhonattan Vegas',     0.60, 287, 7.5, 0.001, 0.30, 12.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:3}],
    ['Michael Thorbjornsen',0.60, 287, 7.5, 0.002, 0.30, 8.0,  {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:2}],
    ['Nicolai Hojgaard',    0.65, 285, 7.0, 0.003, 0.40, 9.0,  {approach:6, aroundGreen:6, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Rasmus Hojgaard',     0.63, 286, 7.2, 0.002, 0.38, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['Chris Gotterup',      0.62, 286, 7.2, 0.002, 0.35, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:7, putting:5, courseHist:2}],
    ['Nico Echavarria',     0.64, 285, 7.0, 0.002, 0.38, 10.0, {approach:6, aroundGreen:5, teeToGreen:6, offTee:6, putting:5, courseHist:3}],
    ['S.H. Kim',            0.62, 286, 7.2, 0.002, 0.35, 10.0, {approach:6, aroundGreen:5, teeToGreen:5, offTee:5, putting:6, courseHist:3}],
    ['Garrick Higgo',       0.60, 287, 7.5, 0.002, 0.32, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:2}],
    ['Sam Stevens',         0.58, 287, 7.5, 0.001, 0.28, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Pierceson Coody',     0.58, 287, 7.5, 0.001, 0.28, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Rico Hoey',           0.55, 288, 7.8, 0.001, 0.25, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ...
    ['Bud Cauley',          0.58, 287, 7.5, 0.001, 0.28, 12.0, {approach:6, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:3}],
    ['Michael Kim',         0.52, 289, 8.0, 0.001, 0.22, 12.0, {approach:4, aroundGreen:4, teeToGreen:4, offTee:5, putting:5, courseHist:3}],
    ['Jordan Smith',        0.58, 287, 7.5, 0.001, 0.28, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Austin Smotherman',   0.55, 288, 7.8, 0.001, 0.25, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:6, putting:5, courseHist:2}],
    ['Matti Schmid',        0.56, 288, 7.5, 0.001, 0.25, 10.0, {approach:5, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Zecheng Dou',         0.52, 289, 8.0, 0.001, 0.22, 12.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Steven Fisk',         0.58, 287, 7.5, 0.001, 0.25, 8.0,  {approach:5, aroundGreen:5, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Joe Highsmith',       0.55, 288, 7.8, 0.001, 0.25, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Michael Brennan',     0.56, 288, 7.5, 0.001, 0.25, 8.0,  {approach:5, aroundGreen:5, teeToGreen:5, offTee:6, putting:5, courseHist:2}],
    ['Jacob Bridgeman',     0.54, 289, 8.0, 0.001, 0.22, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ...
    ['Ricky Castillo',      0.52, 289, 8.0, 0.001, 0.22, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
    ['Ryan Gerard',         0.52, 289, 8.0, 0.001, 0.22, 10.0, {approach:5, aroundGreen:4, teeToGreen:4, offTee:5, putting:5, courseHist:2}],
    ...
    ['Vince Whaley',        0.52, 289, 8.0, 0.001, 0.22, 10.0, {approach:5, aroundGreen:4, teeToGreen:5, offTee:5, putting:5, courseHist:2}],
